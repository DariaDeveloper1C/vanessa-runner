...
Функция ВозможныеКоманды() Экспорт
	...
	Если мВозможныеКоманды = Неопределено Тогда
		...
		мВозможныеКоманды.Вставить("СохранитьВерсиюХранилищаРасширенияВФайл", "unloadcferepo");
...
Процедура ПриРегистрацииКомандПриложения(Знач КлассыРеализацииКоманд) Экспорт
	...
	КлассыРеализацииКоманд[ВозможныеКоманды().СохранитьВерсиюХранилищаРасширенияВФайл]	=
		"КомандаСохранитьВерсиюХранилищаРасширенияВФайл";
